...
python -m prototype_3_gestures.realtime --model "artifacts/v3-realtime-test-candidate/gesture_lstm.pt" --camera "A16" --allow-uncalibrated --confidence 0.72 --cooldown 1.5 --tts-voice "Trúc Ly" --record-dir "%RECORD_DIR%"
